...
mod tests {
    ...
    fn packs_items_into_one_box_if_possible() {
        let items = vec![
            Item { id: 1, width: 100, height: 100, depth: 100, weight: 200, price: 300 },
            Item { id: 2, width: 90, height: 100, depth: 90, weight: 100, price: 200 },
        ];
    ...
    fn splits_items_into_two_boxes_when_needed() {
        let items = vec![
            Item { id: 1, width: 100, height: 200, depth: 100, weight: 500, price: 500 },
            Item { id: 2, width: 100, height: 200, depth: 100, weight: 600, price: 600 },
        ];
